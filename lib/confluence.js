...
function getConfluenceDataAsync(path) {
    ...
    return new Promise((resolve, reject) => {
        ...
        const options = {
            ...
            path: `/wiki/rest/api/content?spaceKey=${this.settings.spaceKey}&title=${encodeURIComponent(path)}&expand=body.view,body.storage,version`,
            method: 'GET',
            headers: {
...
function postConfluenceDataAsync(id, page) {
    ...
    console.log(this.settings.user + ':' + this.settings.pass);
    return new Promise((resolve, reject) => {
