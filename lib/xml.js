...
function updateXml(data, map) {
    ...
    nodes.forEach(n => {
        ...
        if (req.length) {
            ...
            const macro = '<ac:structured-macro ac:name="jira" ac:schema-version="1" ac:macro-id="39b30d60-4df7-44bc-a639-4427802f1cb0"><ac:parameter ac:name="server">JIRA (someJira.atlassian.net)</ac:parameter><ac:parameter ac:name="columns">key,summary,type,created,updated,due,assignee,reporter,priority,status,resolution</ac:parameter><ac:parameter ac:name="serverId">b544e6f4-ac54-35f8-a63d-6d1ebc715244</ac:parameter><ac:parameter ac:name="key">$JIRA-KEY</ac:parameter></ac:structured-macro>'.replace('$JIRA-KEY', map[id]);
